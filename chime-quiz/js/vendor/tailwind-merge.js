/* tailwind-merge (MIT) CommonJS bundle, wrapped for the browser: window.twMerge */
...
const getDefaultConfig = () => {
  ...
  return {
    ...
    classGroups: {
       ...
       */
      leading: [{
        leading: ['none', /** Deprecated since Tailwind CSS v4.0.0. @see https://github.com/tailwindlabs/tailwindcss.com/issues/2027#issuecomment-2620152757 */
      ...
      shadow: [{
        ...
        '',
        // Deprecated since Tailwind CSS v4.0.0
        'inner', 'none', themeShadow, isArbitraryVariableShadow, isArbitraryShadow]
      }],
      /**
       * Box Shadow Color
...
window.twMerge=module.exports.twMerge;})();
