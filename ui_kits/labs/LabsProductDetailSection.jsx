...
// tints its glass to a near-black iris ink), and the sale price uses the
// --error-* status token rather than a raw red.

const LABS_PDP_UPLOADS = window.CHIME_UPLOADS_BASE || "../../uploads";

// Tier → panel data. Selecting a tier drives the price, strikethrough, and
// biomarker count off this map — nothing downstream is hardcoded.
...
function LabsProductDetailSection({
  theme = "lab",
  name = "Total Health Panel – Comprehensive",
  ...
  const [tier, setTier] = React.useState(LABS_TIER_NAMES[0]);
            ...
            <div style={{
              ...
              <div style={{ textAlign: "right", flexShrink: 0 }}>
                <div style={{
                  ...
                  lineHeight: 1.1, color: "var(--error-default)",
                  fontVariantNumeric: "lining-nums",
                }}>{panel.price}</div>
                <div style={{
                  marginTop: "var(--spacing-1)", fontSize: "var(--text-base)",
