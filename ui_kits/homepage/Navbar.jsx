    ...
    <header ref={headerRef} style={{
      ...
      <nav className="nav-bar" style={{
        ...
        <a href={homeHref} aria-label="Chime Health home" className="nav-logo" style={{ display: "inline-flex", alignItems: "center", justifySelf: "start", position: "relative", marginLeft: "var(--spacing-4)" }}>
          <img src={NAV_ASSETS + "/logo-main.svg"} alt="Chime Health" style={{ height: 24, width: "auto", display: "block", opacity: scrolled ? 0 : 1, transition: "opacity var(--transition-base) var(--ease-in-out)" }} />
          {/* Same artwork flattened to white for the dark scrolled pill. */}
          <img src={NAV_ASSETS + "/logo-main.svg"} alt="" aria-hidden="true" style={{ position: "absolute", left: 0, top: "50%", transform: "translateY(-50%)", height: 24, width: "auto", display: "block", filter: "brightness(0) invert(1)", opacity: scrolled ? 1 : 0, transition: "opacity var(--transition-base) var(--ease-in-out)" }} />
        </a>
