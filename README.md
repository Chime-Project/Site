...
├── funnel.html             # Funnel checkout step (Trinity m2/checkout rip): select-plan cards + accordions, payment card, legal footer
...
│   ├── select-plan/        #   select-plan.css / select-plan.js (shared by select-plan.html, -v2 and funnel.html) + img/ payment marks — no React
│   ├── funnel/             #   funnel.css (layered over select-plan.css) + funnel.js (Back button) for funnel.html
