/* chime-deep-belly-burn/product.html: each medication card carries its own plan-length rows; picking a row
   selects medication + length together and the card's Start button opens checkout.html?med&term.
   Prices are the doc's (combo checkout pages v2, 2026-09-25), with a 6 month plan; the 3 month plan is 3 + 1, every 4th month free. The selection also lands in sessionStorage "chime:checkout-selection".
