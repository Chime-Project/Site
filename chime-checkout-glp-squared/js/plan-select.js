/* chime-checkout-glp-squared/product.html: each medication card carries its own plan-length rows; picking a row
...
(function () {
  var CHIME_PLANS = {
    glp2: { key: "glp2", name: "GLP Squared", full: "Compounded GLP Squared", image: "images/vial-glp-squared.webp",
